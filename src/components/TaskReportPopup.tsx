    ...
    if (!documents.length) {
      return (
        <p className="text-xs text-slate-500">
          {t({ ko: "No documents", en: "No documents", ja: "ドキュメントなし", zh: "暂无文档" })}
        </p>
      );
    }
          ...
          return (
            <div key={doc.id} className="rounded-lg border border-slate-700/60 bg-slate-800/50 p-3">
              <div className="mb-2 flex items-center justify-between gap-2">
                ...
                >
                  {isExpanded
                    ? t({ ko: "Collapse", en: "Collapse", ja: "折りたたむ", zh: "收起" })
                    : t({ ko: "Expand", en: "Expand", ja: "展開", zh: "展开" })}
                </button>
              </div>
    ...
    <div className="space-y-3">
      <div className="rounded-lg border border-emerald-500/30 bg-emerald-500/10 p-3">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              {refreshingArchive
                ...
                : t({ ko: "Refresh Consolidation", en: "Refresh Consolidation", ja: "統合更新", zh: "刷新汇总" })}
            </button>
        ...
        <pre className="max-h-[60vh] overflow-auto whitespace-pre-wrap text-xs leading-relaxed text-emerald-100">
          {planningSummary?.content ||
            t({ ko: "No summary text", en: "No summary text", ja: "サマリーなし", zh: "暂无摘要内容" })}
        </pre>
      </div>
      ...
      <div>
        <p className="mb-2 text-xs font-medium uppercase tracking-wider text-slate-500">
          {t({ ko: "Source Documents", en: "Source Documents", ja: "原本文書", zh: "原始文档" })}
        </p>
      ...
      <div className="space-y-3">
        <div className="rounded-lg border border-slate-700/60 bg-slate-800/50 p-3">
          ...
          <p className="mt-1 text-xs text-slate-500">
            {t({ ko: "Completed", en: "Completed", ja: "完了", zh: "完成" })}: {fmtTime(team.completed_at)}
          </p>
        ...
        {team.linked_subtasks.length > 0 && (
          <div className="rounded-lg border border-slate-700/50 bg-slate-900/60 p-3">
            <p className="mb-2 text-xs font-medium uppercase tracking-wider text-slate-500">
              {t({ ko: "Linked Subtasks", en: "Linked Subtasks", ja: "関連サブタスク", zh: "关联子任务" })}
            </p>
            <div className="space-y-1.5">
        ...
        <div>
          <p className="mb-2 text-xs font-medium uppercase tracking-wider text-slate-500">
            {t({ ko: "Team Documents", en: "Team Documents", ja: "チーム文書", zh: "团队文档" })}
          </p>
        ...
        {keyLogs.length > 0 && (
          <div className="rounded-lg border border-slate-700/50 bg-slate-900/60 p-3">
            <p className="mb-2 text-xs font-medium uppercase tracking-wider text-slate-500">
              {t({ ko: "Progress Logs", en: "Progress Logs", ja: "進行ログ", zh: "进度日志" })}
            </p>
      ...
      >
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="mt-1 flex flex-wrap items-center gap-2 text-xs text-slate-400">
                ...
                <span>
                  {t({ ko: "Completed", en: "Completed", ja: "完了", zh: "完成" })}:{" "}
        ...
        <div className="border-b border-slate-700/40 px-6 py-2.5">
          <div className="flex flex-wrap items-center gap-2">
            ...
            >
              {t({ ko: "Planning Summary", en: "Planning Summary", ja: "企画サマリー", zh: "规划汇总" })}
            </button>
