...
export default function DecisionInboxModal({
  ...
  const getKindLabel = (kind: DecisionInboxItem["kind"]) => {
    if (kind === "project_review_ready") {
      return t({ ko: "Project Decision", en: "Project Decision", ja: "プロジェクト判断", zh: "项目决策" });
    }
    if (kind === "task_timeout_resume") {
      return t({ ko: "Timeout Resume", en: "Timeout Resume", ja: "中断タスク再開", zh: "超时任务续跑" });
    }
    ...
    return t({ ko: "Agent Request", en: "Agent Request", ja: "エージェント要請", zh: "代理请求" });
  };
        ...
        <div className="flex items-center justify-between border-b border-slate-700/50 px-6 py-4">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-lg font-bold text-white">
              {t({ ko: "Pending Decisions", en: "Pending Decisions", ja: "未決の意思決定", zh: "待处理决策" })}
            </h2>
                ...
                <div key={item.id} className="rounded-xl border border-slate-700/60 bg-slate-800/50 p-3">
                  <div className="mb-2 flex flex-wrap items-center justify-between gap-2">
                    ...
                    {item.agentId ? (
                      ...
                      >
                        {t({ ko: "Open Chat", en: "Open Chat", ja: "チャットを開く", zh: "打开聊天" })}
                      </button>
                    ) : null}
                  </div>
                          ...
                          <div className="space-y-2">
                            ...
                            <div className="flex flex-wrap items-center justify-end gap-2">
                              {skipOption ? (
                                ...
                                >
                                  {isItemBusy
                                    ? t({ ko: "Sending...", en: "Sending...", ja: "送信中...", zh: "发送中..." })
            ...
            <div className="mt-2 flex items-center justify-end gap-2">
              ...
              >
                {isFollowupSubmitting
                  ? t({ ko: "Sending...", en: "Sending...", ja: "送信中...", zh: "发送中..." })
                  : t({ ko: "Submit Request", en: "Submit Request", ja: "要請登録", zh: "提交请求" })}
              </button>
            </div>
          </div>
        ) : null}
