...
export const STATUS_BADGES: Record<string, { label: LangText; color: string }> = {
  in_progress: {
    label: { ko: "Running", en: "Running", ja: "実行中", zh: "运行中" },
    color: "bg-amber-500/20 text-amber-400 border-amber-500/40",
  },
  review: {
    label: { ko: "Review", en: "Review", ja: "レビュー", zh: "审核" },
    color: "bg-purple-500/20 text-purple-400 border-purple-500/40",
  },
  done: {
    label: { ko: "Done", en: "Done", ja: "完了", zh: "完成" },
    color: "bg-green-500/20 text-green-400 border-green-500/40",
  },
  inbox: {
    label: { ko: "Inbox", en: "Inbox", ja: "受信箱", zh: "收件箱" },
    color: "bg-slate-500/20 text-slate-400 border-slate-500/40",
  },
  planned: {
    label: { ko: "Planned", en: "Planned", ja: "予定", zh: "计划" },
    color: "bg-blue-500/20 text-blue-400 border-blue-500/40",
  },
  cancelled: {
    label: { ko: "Cancelled", en: "Cancelled", ja: "キャンセル", zh: "已取消" },
