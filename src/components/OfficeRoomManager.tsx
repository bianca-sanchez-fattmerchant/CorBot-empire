...
const labels = {
  title: { ko: "Office Manager", en: "Office Manager", ja: "オフィス管理", zh: "办公室管理" },
  accent: { ko: "Main Color", en: "Main Color", ja: "メインカラー", zh: "主色调" },
  tone: { ko: "Tone (Brightness)", en: "Tone (Brightness)", ja: "トーン（明るさ）", zh: "色调（亮度）" },
  reset: { ko: "Reset", en: "Reset", ja: "リセット", zh: "重置" },
  resetAll: { ko: "Reset All", en: "Reset All", ja: "全てリセット", zh: "全部重置" },
  close: { ko: "Close", en: "Close", ja: "閉じる", zh: "关闭" },
  presets: { ko: "Presets", en: "Presets", ja: "プリセット", zh: "预设" },
};
